...
class FiniteField {
     ...
     * @param {bigint|number} p - The order of a finite field.
     */
    ...
    /**
     * Calculate the square root of a value over this instance of a finite field.
     * - Note: This function assumes the order of the field is equivalent to 3 mod 4 and that value `a` is a quadratic residue over this instance of a finite field.
     * @param {bigint|number} a - The value to calculate the square root of.
     * @returns {bigint} The square root of the value over this instance of a finite field.
     */
    sqrt_p3mod4(a:bigint|number):bigint {
        return FiniteField.sqrt_p3mod4(this.p, a);
    }
     ...
     */
    static sqrt_p3mod4(p:bigint|number, a:bigint|number):bigint {
        p = BigInt(p);
        a = BigInt(a);
        const e = p + 1n >> 2n;
        return FiniteField.power(p, a, e);
    }
